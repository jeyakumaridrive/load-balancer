...
(function() {
    ...
    function getContext(id) {
        ...
        canv.setAttribute('width', iWidth);
        canv.setAttribute('height', iHeight);
    ...
    var drawHelper = {
        redraw: function() {
            tempContext.clearRect(0, 0, iWidth, iHeight);
        ...
        arc: function(context, point, options) {
            ...
            if(point[2] < 0) {
                context.beginPath();
                context.arc(point[0]-(point[2]), point[1]-(point[2]), -point[2], point[3], 0, point[4]);
            } else {
                context.beginPath();
    ...
    var pencilHandler = {
        ...
        mousedown: function(e) {
            ...
            drawHelper.pencil(tempContext, [t.prevX, t.prevY, x, y]);

            points[points.length] = ['pencil', [t.prevX, t.prevY, x, y], drawHelper.getOptions(), 'start'];
        ...
        mouseup: function(e) {
            ...
            if (t.ismousedown) {
                ...
                points[points.length] = ['pencil', [t.prevX, t.prevY, x, y], drawHelper.getOptions(), 'end'];
        ...
        mousemove: function(e) {
            ...
            if (t.ismousedown) {
                ...
                points[points.length] = ['pencil', [t.prevX, t.prevY, x, y], drawHelper.getOptions()];
    ...
    var markerHandler = {
        ...
        mousedown: function(e) {
            ...
            points[points.length] = ['line', [t.prevX, t.prevY, x, y], markerDrawHelper.getOptions(), 'start'];
    ...
    markerDrawHelper.getOptions = function() {
        return [(parseInt(lineWidth)+10), markerStrokeStyle, fillStyle, markerGlobalAlpha, globalCompositeOperation, lineCap, lineJoin, font];
    }
    ...
    var eraserHandler = {
        ...
        mousemove: function(e) {
            ...
            if (t.ismousedown) {
                tempContext.lineCap = 'round';
                tempContext.lineWidth = 20;
                drawHelper.line(tempContext, [t.prevX, t.prevY, x, y], drawHelper.getOptions({
                    lineWidth: 20
                }));
        ...
        mouseup: function(e) {
            ...
            if (g.ismousedown) {
                if (!g.isCircleDrawn && g.isCircledEnded) {
                    ...
                    angle = (xx + yy) / (2 * c);
                    points[syncPointer] = ['arc', [prevX + radius, prevY + radius, radius, Math.PI*2, true], drawHelper.getOptions()];

                    // var arcRange = g.arcRange,
                    //     arcRangeContainer = g.arcRangeContainer;

                    // arcRangeContainer.style.display = 'none';
                    // arcRange.focus();
        ...
        mousemove: function(e) {
            ...
            if (ismousedown) {
                if (!isCircleDrawn && isCircleEnded) {
                    ...
                    syncData({
                        points: [points[syncPointer]],
                        startIndex: syncPointer
                    });
                }
            }
        },
    ...
    var lineHandler = {
        ...
        mouseup: function(e) {
            ...
            var t = this;
            if (t.ismousedown) {
                points[syncPointer] = ['line', [t.prevX, t.prevY, x, y], drawHelper.getOptions()];
                t.ismousedown = false;
            }
        },
        mousemove: function(e) {
    ...
    var arrowHandler = {
        ...
        mouseup: function(e) {
            ...
            var t = this;
            if (t.ismousedown) {
                points[syncPointer] = ['arrow', [t.prevX, t.prevY, x, y], drawHelper.getOptions()];
    ...
    var rectHandler = {
        ...
        mouseup: function(e) {
            ...
            var t = this;
            if (t.ismousedown) {
                points[syncPointer] = ['rect', [t.prevX, t.prevY, x - t.prevX, y - t.prevY], drawHelper.getOptions()];
    ...
    var quadraticHandler = {
        ...
        mousemove: function(e) {
            ...
            if (g.ismousedown && g.isFirstStep) {
                ...
                syncData({
                    points: [['quadratic', [g.prevX, g.prevY, x, y, x, y], drawHelper.getOptions()]],
                    startIndex: syncPointer
                });
            }
            ...
            if (g.isLastStep) {
                ...
                points[syncPointer] = ['quadratic', [g.prevX, g.prevY, g.controlPointX, g.controlPointY, x, y], drawHelper.getOptions()];
                syncData({
                    points: [points[syncPointer]],
                    startIndex: syncPointer
                });
    ...
    var data_uris = {
        line: icons.line || 'data:image/png;base64,',
        arrow: icons.arrow || 'data:image/png;base64,',
        ...
        rectangle: icons.rectangle || 'data:image/png;base64,',
        arc: icons.arc || 'data:image/png;base64,',
        ...
        lineWidth: icons.lineWidth || 'data:image/png;base64,',
        colorsPicker: icons.colorsPicker || 'data:image/png;base64,',
        ...
        undoAll: icons.undoAll || 'data:image/png;base64,',
    ...
    (function() {
        ...
        toolBox.style.height = (iHeight) + 'px'; // -toolBox.offsetTop - 77
            ...
            image.onload = function() {
                ...
                document.querySelector('#undo').onclick = function() {
                    if (points.length) {
                        ...
                        if((lastPoint[0] == 'pencil' || lastPoint[0] == 'line') && lastPoint[3] == "end") {
                            while (lastPoint[3] != "start") {
        ...
        document.getElementById('lineWidthRange').onchange = function () {
            setTimeout(() => {
                document.getElementById('line-width-container').style.display = 'none';
            }, 300);
        }

        document.getElementById('lineWidthRange').oninput = function () {
            document.getElementById("lineWidth").innerHTML = this.value;
        ...
        document.getElementById('hide-reset-container').onclick = function () {
            hideResetPopup();
        }
        ...
        function decorateUndoAll() {
            var context = getContext('undoAll');

            var image = new Image();
            image.onload = function() {
                context.drawImage(image, 4, 4, 32, 32);

                document.querySelector('#undoAll').onclick = function() {
                    
                    showResetPopup();

                };
            };
            image.src = data_uris.undoAll;
        }

        if (tools.undoAll === true) {
            decorateUndoAll();
            document.getElementById('undoAll').style.display = 'block';
        }
        ...
        function decorateLineWidth() {
            ...
            var lineWidthContainer = find('line-width-container'),
                ...
                btnLineWidthClose = find('line-width-close'),
            ...
            addEvent(canvas, 'click', function() {
                ...
                lineWidthContainer.style.top = (canvas.offsetTop + 1) + 52 + 'px';
                lineWidthContainer.style.left = (canvas.offsetLeft + canvas.clientWidth) + 32 + 'px';
            ...
            addEvent(btnLineWidthClose, 'click', function() {
                lineWidthContainer.style.display = 'none';
        ...
        function decorateColors() {
            ...
            var colorsContainer = find('colors-container'),
                ...
                btnColorsClose = find('colors-close'),
                h1 = document.getElementsByTagName('h1')[0],
                canvas = context.canvas;
            ...
            addEvent(canvas, 'click', function() {
                ...
                colorsContainer.style.top = (canvas.offsetTop + 1) + 10 + 'px';
                colorsContainer.style.left = (canvas.offsetLeft + canvas.clientWidth) + 32 + 'px';

                strokeStyleText.focus();
                console.log(fillStyle);
                console.log(fillStyleText.value);
            });
            ...
            addEvent(btnColorsClose, 'click', function() {
                console.log(fillStyle);
                console.log(fillStyleText.value);
                colorsContainer.style.display = 'none';
                strokeStyleText.value = strokeStyle;
                fillStyleText.value = fillStyle;
            });
        }
        ...
        function setHeightForCodeAndOptionsContainer() {
            codeText.style.width = (iWidth - optionsContainer.clientWidth - 30) + 'px';
            codeText.style.height = (iHeight - 40) + 'px';

            codeText.style.marginLeft = (optionsContainer.clientWidth) + 'px';
            optionsContainer.style.height = (iHeight) + 'px';
        }
